    ...
    <>
      ...
      <div className="relative w-full h-100 flex justify-center items-center overflow-hidden mt-21.25">
        ...
        <div className="logo-text">
          <p className="text-accent text-[5rem] [text-shadow:2px_3px_9px_rgba(0,0,0,0.6)]">نبذة عن المعهد العربي</p>
        </div>
      </div>
      <main className="page-content">
        ...
        <div className="flex flex-col items-center gap-7.5 p-5 bg-[#f4f4f4]">
          <div className="w-full max-w-225 shadow-[0_4px_15px_rgba(0,0,0,0.1)] rounded-[10px] overflow-hidden" data-aos="fade-up">
            <img src="assets/Brief/بروفايل-0٢.jpg" alt="نبذة عنا" className="w-full h-auto block" />
          </div>
        </div>
      </main>
      <Footer />
