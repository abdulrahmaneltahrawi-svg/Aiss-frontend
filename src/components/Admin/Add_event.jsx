...
// المسار المطابق للمسار الخلفي: Route::post('/events', [EventController::class, 'store']);
const POST_URL = `${API_URL}/api/events`;
...
function Add_event() {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (!res.ok) {
        alert(data.message || "فشل إضافة الفعالية");
        setSaving(false);
        return;
      }
...
<div className="mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-center">
            ...
            >
              {saving ? "جاري الحفظ..." : "حفظ ونشر الفعالية"}
            </button>
