...
function Add_conferences() {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (!res.ok) {
        alert(data.message || "فشل إضافة المؤتمر");
        setSaving(false);
        return;
      }

      alert("تم إضافة المؤتمر بنجاح");
      navigate("/admin");
    } catch (err) {
      console.error(err);
      setSaving(false);
        ...
        >
          ...
          <div className="mb-5">
            ...
            <input
              ...
              placeholder="مثال: مؤتمر السلامة العربي السادس"
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-center">
            ...
            >
              {saving ? "جاري الحفظ..." : "حفظ ونشر المؤتمر"}
            </button>
...
export default Add_conferences;